...
namespace MicroDocWeb
{
    public partial class Test : System.Web.UI.Page
    {
        ...
        protected void btnPrint_Click(object sender, EventArgs e)
        {
            ...
            string html = string.Format("<html><body><h2>aswin vp</h2><br/><p width=100px><font face='calibri' size="+size+">" + strDoc+"</font></p></body></html>");
            GeneratePDF(html);
        }
        ...
        {
            //test
            MicroDoc.Objects.Page page = new MicroDoc.Objects.Page();
